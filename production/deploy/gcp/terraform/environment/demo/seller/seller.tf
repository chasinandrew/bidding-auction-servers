...
module "seller" {
  ...
  runtime_flags = {
    ...
    ROMA_TIMEOUT_MS                 = "10000" # Example: "10000"
    TELEMETRY_CONFIG                = "mode: EXPERIMENT" # Example: "mode: EXPERIMENT"
    COLLECTOR_ENDPOINT              = "collector-seller-1-${local.environment}.sfe-gcp.com:4317" # Example: "collector-seller-1-${local.environment}.sfe-gcp.com:4317"
    ENABLE_OTEL_BASED_LOGGING       = "false" # Example: "false"
    CONSENTED_DEBUG_TOKEN           = "test" # Example: "<unique_id>"
    ENABLE_REPORT_WIN_INPUT_NOISING = "false" # Example: "true"
